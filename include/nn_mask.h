...
/**
 *	The following defines ware taken for the x.h (x11 library), you can find
 *	them either in your local library in linux `/usr/include/X11/X.h` or here
 *	`https://code.woboq.org/gtk/include/X11/X.h.html`. This defines helps us
 *	detect specific GUI events or talk to the event manager.
**/
